...
def load_data(messages_filepath, categories_filepath):
    ...
    Arguments:
        messages_filepath -> Path to the messages data cvs
        categories_filepath -> Path to the categories data cvs
    Output:
...
def clean_data(df):
    ...
    for column in categories:
        newcols = categories[column].str.split('-', n = 1, expand = True)
        categories[column] = newcols[1].astype(int)
